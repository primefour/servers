...
func InitWeb() {
	...
	if *utils.Cfg.ServiceSettings.WebserverMode != "disabled" {
		...
		mainrouter.Handle("/{anything:.*}", api4.AppHandlerIndependent(root)).Methods("GET")
	}
}
...
func CheckBrowserCompatability(c *api4.Context, r *http.Request) bool {
...
func root(c *api4.Context, w http.ResponseWriter, r *http.Request) {
