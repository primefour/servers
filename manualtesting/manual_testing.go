...
type TestEnvironment struct {
	...
	Context       *api4.Context
	Writer        http.ResponseWriter
	Request       *http.Request
}

func InitManualTesting() {
	app.Srv.Router.Handle("/manualtest", api4.ApiHandler(manualTest)).Methods("GET")
}

func manualTest(c *api4.Context, w http.ResponseWriter, r *http.Request) {
	// Let the world know
